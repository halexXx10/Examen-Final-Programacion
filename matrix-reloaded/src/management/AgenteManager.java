...
public class AgenteManager {
    ...
    public AgenteManager() {
        ...
        Agente agente = new Agente(1, "Neo", "Control de la Matrix");
        agente.registrarMisionCompletada("Salvar a Morfeo");
        agente.registrarAnomaliaNeutralizada("Anomalía en el Sector 5");
